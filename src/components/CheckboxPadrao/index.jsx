...
const CheckboxPadrao = ({id, checked, onChange, disabled = false, onClick}) => {
    return (
        <div className={styles.checkboxInput}>
            <input type="checkbox" id={id} checked={checked} onChange={onChange} disabled={disabled} onClick={onClick} />
