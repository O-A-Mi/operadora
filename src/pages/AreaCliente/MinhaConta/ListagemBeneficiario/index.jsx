  ...
  return (
    <>
      <div className={styles.beneficiariosContainer} id="empresa-beneficiarios-container">
        <h2 className={styles.beneficiariosTitleTela}><i className="fa-solid fa-users"></i>Listagem de Beneficiários</h2>
            ...
            <div className={styles.filtroTabelaContent}>
              ...
              <div className={styles.filtroTabelaBody}>
                ...
                <UseInputPadrao
                  ...
                  width={isMobile ? 100 : 33.33} gap={isMobile ? 0 : 0.666}
                  onBlur={() => filtrarBeneficiarios()}
                  onKeyPress={(e) => { if (e.key === 'Enter') filtrarBeneficiarios() }}
                ...
                <UseInputPadrao
                  ...
                  width={isMobile ? 50 : 33.33} gap={isMobile ? 0.5 : 0.666}
                  onBlur={() => filtrarBeneficiarios()}
                  onKeyPress={(e) => { if (e.key === 'Enter') filtrarBeneficiarios() }}
            ...
            options={{
              ...
              additionalButtons:
                [{
                  ...
                  onClick: () => navigate(`/${jsonRoute.Operadora_MinhaConta}/${jsonRoute.CriarClientOperadora}`)
                }]
            }}
          />
        </div>
