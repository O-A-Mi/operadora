...
import ModalLog from '../components/modalLogAuditodia/modalLogAuditodia.jsx';
...
const CriarClienteOperadora = () => {
  ...
  if (screenState.voltar) {
    handleNavigate(`/${jsonRoute.Operadora_MinhaConta}/${jsonRoute.Listagem_Beneficiarios}`);
  }

  return (
    <>
    <h2 className={styles.titulo}><i className="fa-solid fa-users"></i>Listagem de Beneficiários</h2>
...
export default CriarClienteOperadora;
