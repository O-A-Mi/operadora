...
export default function ModalAdressRepresentante({onClose, isOpen, initialData, setFuncs}) {
  ...
  const [cep, handleCepChange, cepRef] = UseInputMask( "99999-999", "number", conteudo.cep);
  const [endereco, handleEnderecoChange, enderecoRef] = UseInputMask( null, "text", conteudo.endereco);
  const [numero, handleNumeroChange, numeroRef] = UseInputMask( null, "number", conteudo.numero);
  const [complemento, handleComplementoChange, complementoRef] = UseInputMask( null, "text", conteudo.complemento);
  const [bairro, handleBairroChange, bairroRef] = UseInputMask( null, "text", conteudo.bairro);
  const [uf, handleUfChange, ufRef] = UseInputMask( null, "text", conteudo.uf);
  const [cidade, handleCidadeChange, cidadeRef] = UseInputMask( null, "text", conteudo.cidade);
