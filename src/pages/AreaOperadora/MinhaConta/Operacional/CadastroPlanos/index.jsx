...
const CadastroPlanos = () => {
  ...
  const handleRowClick = (row, rowIndex) => {
    navigate(`/${jsonRoute.AreaOperadora}/${jsonRoute.Operacional}/${jsonRoute.CadastroPlanos}/${jsonRoute.CadastroPlanosNovo}`, {
      state: {
        planoParaEdicao: row,
        modoEdicao: true
      }
              ...
              additionalButtons: [
                {
                  ...
                  onClick: () => navigate(`/${jsonRoute.AreaOperadora}/${jsonRoute.Operacional}/${jsonRoute.CadastroPlanos}/${jsonRoute.CadastroPlanosNovo}`)
                }
              ]
            }}
          />
