            ...
            <div className={styles.communicationColumn}>
              ...
              <div className={styles.inputWithButton}>
                ...
                />
                   ...
                   onClick={() => handleVisualizar('SMS', 'Associado')}
                 >
            ...
            <div className={styles.communicationColumn}>
              ...
              <div className={styles.inputWithButton}>
                ...
                />
                                 <button 
                   className={styles.visualizarButton}
                   onClick={() => handleVisualizar('SMS', 'Segurado')}
                 >
                   <i className="fa-solid fa-eye"></i>
                   Visualizar
                 </button>
            ...
            <div className={styles.communicationColumn}>
              ...
              <div className={styles.inputWithButton}>
                ...
                />
                                 <button 
                   className={styles.visualizarButton}
                   onClick={() => handleVisualizar('SMS', 'Dependente')}
                 >
                   <i className="fa-solid fa-eye"></i>
                   Visualizar
                 </button>
            ...
            <div className={styles.communicationColumn}>
              ...
              <div className={styles.inputWithButton}>
                ...
                />
                                 <button 
                   className={styles.visualizarButton}
                   onClick={() => handleVisualizar('Email', 'Associado')}
                 >
                   <i className="fa-solid fa-eye"></i>
                   Visualizar
                 </button>
            ...
            <div className={styles.communicationColumn}>
              ...
              <div className={styles.inputWithButton}>
                ...
                />
                                 <button 
                   className={styles.visualizarButton}
                   onClick={() => handleVisualizar('Email', 'Segurado')}
                 >
                   <i className="fa-solid fa-eye"></i>
                   Visualizar
                 </button>
            ...
            <div className={styles.communicationColumn}>
              ...
              <div className={styles.inputWithButton}>
                ...
                />
                                 <button 
                   className={styles.visualizarButton}
                   onClick={() => handleVisualizar('Email', 'Dependente')}
                 >
                   <i className="fa-solid fa-eye"></i>
                   Visualizar
                 </button>
            ...
            <div className={styles.communicationColumn}>
              ...
              <div className={styles.inputWithButton}>
                ...
                />
                                 <button 
                   className={styles.visualizarButton}
                   onClick={() => handleVisualizar('Mobile', 'Associado')}
                 >
                   <i className="fa-solid fa-eye"></i>
                   Visualizar
                 </button>
            ...
            <div className={styles.communicationColumn}>
              ...
              <div className={styles.inputWithButton}>
                ...
                />
                                 <button 
                   className={styles.visualizarButton}
                   onClick={() => handleVisualizar('Mobile', 'Segurado')}
                 >
                   <i className="fa-solid fa-eye"></i>
                   Visualizar
                 </button>
            ...
            <div className={styles.communicationColumn}>
              ...
              <div className={styles.inputWithButton}>
                ...
                />
                                 <button 
                   className={styles.visualizarButton}
                   onClick={() => handleVisualizar('Mobile', 'Dependente')}
                 >
                   <i className="fa-solid fa-eye"></i>
                   Visualizar
                 </button>
            ...
            <div className={styles.communicationColumn}>
              ...
              <div className={styles.inputWithButton}>
                ...
                />
                                 <button 
                   className={styles.visualizarButton}
                   onClick={() => handleVisualizar('WhatsApp', 'Associado')}
                 >
                   <i className="fa-solid fa-eye"></i>
                   Visualizar
                 </button>
            ...
            <div className={styles.communicationColumn}>
              ...
              <div className={styles.inputWithButton}>
                ...
                />
                                 <button 
                   className={styles.visualizarButton}
                   onClick={() => handleVisualizar('WhatsApp', 'Segurado')}
                 >
                   <i className="fa-solid fa-eye"></i>
                   Visualizar
                 </button>
            ...
            <div className={styles.communicationColumn}>
              ...
              <div className={styles.inputWithButton}>
                ...
                />
                                 <button 
                   className={styles.visualizarButton}
                   onClick={() => handleVisualizar('WhatsApp', 'Dependente')}
                 >
                   <i className="fa-solid fa-eye"></i>
                   Visualizar
                 </button>
            ...
            Hotlink
             ...
             <div className={styles.hotlinkRow}>
               <div className={styles.hotlinkColumn}>
                 <h4 className={styles.hotlinkTitle}>Associado</h4>
                 <UseInputPadrao 
             ...
             <div className={styles.hotlinkRow}>
               <div className={styles.hotlinkColumn}>
                 <h4 className={styles.hotlinkTitle}>Segurado</h4>
                 <UseInputPadrao 
             ...
             <div className={styles.hotlinkRow}>
               <div className={styles.hotlinkColumn}>
                 <h4 className={styles.hotlinkTitle}>Dependente</h4>
                 <UseInputPadrao 
