...
const Plano = () => {
  ...
  const arquivoPlanoRef = useRef(null);
  ...
  function downloadArchive(type){
    ...
    let nomeArquivo = type == 'layout' ? 'layout-importacao-plano.xlsx' : 'exemplo-importacao-plano.xlsx';

    if(type == 'layout'){
      link.href = 'operadora/public/archives/Carterinha/layout-importacao-plano.xlsx'
    }else if(type == 'exemplo'){
      link.href = 'operadora/public/archives/Carterinha/exemplo-importacao-plano.xlsx'
    }else{
      return false;
    }
  ...
  return (
    <>
      <div className={styles.planoContainer} id="plano-container">
        ...
        <div className={styles.planoContent}>
          <div className={styles.conteudoPlanoContent}>
            <div className={styles.conteudoPlanoBody}>
              <UseInputPadrao
                label="Pesquisar"
              ...
              <div className={styles.conteudoImportacaoPlano}>
                <div className={styles.headerImportacaoPlano}>
                  <i className="fa-solid fa-file"></i>
                  Arquivo da Plano
                </div>
                <UseInputPadrao
                  label="Arquivo da Plano (.xlsx)"
                  ...
                  gap={isMobile ? 0 : 0.5}
                />
                <div className={styles.opcoesImportacaoPlano}>
                  <div className={styles.botoesImportacaoPlano}>
                    Layout de Importação da Plano
              ...
              <div className={styles.footerBotoesPlano}>
                <button>
