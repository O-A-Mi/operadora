...
import ModalLog from './modalLogAuditoria/modalLogAuditodia.jsx'
...
const CriarBeneficiario = () => {
  ...
  if (screenState.voltar) {
    handleNavigate(`/${jsonRoute.AreaOperadora}/${jsonRoute.Operacional}/${jsonRoute.CadastroBeneficiarios}`);
  }
