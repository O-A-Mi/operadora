                ...
                <div className={styles.filtroTabelaContent}>
                  <div className={styles.filtroTabelaBody}>
                    ...
                    <div className={styles.spaceInput}>
                      <div className={styles.contentBox}>
                        <div className={styles.buttonText}>
                          <h3 className={styles.titleBox}>Bloqueado</h3>
                        </div>
                        <TogglePadrao
                          label="Ativar"
                          checked={pagou === 'Sim'}
                    ...
                    <div className={styles.spaceInput}>
                      <div className={styles.contentBox}>
                        <div className={styles.buttonText}>
                          <h3 className={styles.titleBox}>Inativo</h3>
                        </div>
                        <TogglePadrao
                          label="Ativar"
                          checked={pagou === 'Sim'}
                        ...
                        <div className={styles.contentBoxAlign}>
                          ...
                          />
                          <UseInputPadrao 
                            label="Ação FI - Cobrança em aberto"
                            identifier="texto"
                            type='select'
                            value={textoBusca}
                            onChange={textoBuscaChange}
                    ...
                    <div className={styles.spaceInput}>
                      <div className={styles.contentBox}>
                        <div className={styles.buttonText}>
                          <h3 className={styles.titleBox}>Excluído</h3>
                        </div>
                        <TogglePadrao
                          label="Ativar"
                          checked={pagou === 'Sim'}
                        ...
                        <div className={styles.contentBoxAlign}>
                          ...
                          />
                          <UseInputPadrao 
                            label=">= qtd de dias (Hoje - Vigência ou Cadastro)"
                            identifier="texto"
                            type='select'
                            value={textoBusca}
                            onChange={textoBuscaChange}
                          ...
                          />
                          <UseInputPadrao 
                            label="Lista de Andamento da Proposta"
                            identifier="texto"
                            type='select'
                            value={textoBusca}
                            onChange={textoBuscaChange}
                    ...
                    <div className={styles.spaceInput}>
                      <div className={styles.contentBox}>
                        <div className={styles.buttonText}>
                          <h3 className={styles.titleBox}>Associado</h3>
                          <h3>Inativar - sem proposta/contrato ativa</h3>
                        </div>
                        <TogglePadrao
                          label="Ativar"
                          checked={pagou === 'Sim'}
...
export default AgendadorMudarStatus;
