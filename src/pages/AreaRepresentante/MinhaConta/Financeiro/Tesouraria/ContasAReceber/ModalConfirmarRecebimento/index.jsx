...
const ModalConfirmarRecebimento = ({ isOpen, onClose }) => {
  ...
  const handleGravar = () => {
    onClose();
    toastMessage("Recebimento confirmado com sucesso!", "success");
  };
      ...
      <div className={styles.modalContent}>
        <div className={styles.modalHeader}>
          <div className={styles.modalHeaderLeft}>
            ...
            <h2 className={styles.modalTitle}>Confirmar Recebimento</h2>
          </div>
