...
const ModalWhatsapp = ({ isOpen, onClose, destinatario }) => {
  ...
  const [caracteresRestantes, setCaracteresRestantes] = useState(450);
  ...
  const modelosWhatsapp = [
    {
      id: "modelo1",
      nome: "Lembrete de Pagamento",
      mensagem: "Olá [NOME]! 👋\n\nLembramos que seu boleto vence em [DIAS] dias. Para evitar a suspensão dos serviços, efetue o pagamento o quanto antes.\n\nEm caso de dúvidas, estamos à disposição.\n\nAtenciosamente,\nEquipe Hermanos Saúde 💙"
    },
    {
      id: "modelo2", 
      nome: "Confirmação de Agendamento",
      mensagem: "Olá [NOME]! 🗓️\n\nSua consulta foi agendada com sucesso para [DATA] às [HORA].\n\nPor favor, confirme sua presença respondendo esta mensagem.\n\nEm caso de necessidade de reagendamento, entre em contato conosco.\n\nAtenciosamente,\nEquipe Hermanos Saúde 💙"
    },
    {
      id: "modelo3",
      nome: "Boas-vindas",
      mensagem: "Olá [NOME]! 🎉\n\nSeja bem-vindo(a) à Hermanos Saúde!\n\nSeu plano está ativo e você já pode acessar sua carteirinha digital.\n\nEstamos aqui para cuidar da sua saúde com qualidade e dedicação.\n\nAtenciosamente,\nEquipe Hermanos Saúde 💙"
    }
  ];
  ...
  useEffect(() => {
    if (modeloSelecionado) {
      const modelo = modelosWhatsapp.find((m) => m.id === modeloSelecionado);
      if (modelo) {
  ...
  useEffect(() => {
    const restantes = 450 - mensagem.length;
  ...
  const handleEnviar = () => {
    ...
    toastMessage("Mensagem do WhatsApp enviada com sucesso!", "success");
    onClose();
  };
      ...
      <div className={styles.modalContent}>
        <div className={styles.modalHeader}>
          <div className={styles.modalHeaderLeft}>
            ...
            <h2 className={styles.modalTitle}>WhatsApp</h2>
          </div>
