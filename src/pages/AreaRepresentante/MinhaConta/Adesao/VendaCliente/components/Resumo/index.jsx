                ...
                <div className={styles.cardsGrid}>
                  ...
                  <div className={styles.CardGridColumn}>
                    <Card
                        ...
                        icon="fas fa-users"
                        >
                        <InfoField label="Plano Escolhido:" value={dadosBeneficiario.nome} />
                        <InfoField label="Quantidade de Titulares:" value={dadosBeneficiario.nome} />
                    ...
                    <Card
                        ...
                        >
                        <InfoField label="Tipo de Pagamento:" value={dadosChamado.tipoSolicitacao} />
