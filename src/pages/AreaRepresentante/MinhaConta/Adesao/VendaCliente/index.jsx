...
const VendaCLiente = () => {
    ...
    const [steps, setSteps] = useState([
        { id: 1, name: 'Contratante', icon: 'fas fa-building', color: '#d69e2e' },
        { id: 2, name: 'Tipo Plano & Plano', icon: 'fa-solid fa-file-waveform', color: '#4a5568' },
        { id: 3, name: 'Beneficiários', icon: 'fas fa-restroom', color: '#73cd95' },
        { id: 4, name: 'Simulação', icon: 'fa fa-calculator', color: '#87a6be' },
    ...
    function handleViewMode(){
        ...
        if (viewMode){
            ...
            setSteps([
                ...
                { id: 5, name: 'Simulação', icon: 'fa fa-calculator', color: '#87a6be' },
                ...
                <div>
                    <div className={styles.vendaClienteContent}>
                        <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
                            ...
                            <div>
                                {currentStep === 4 && <Simulacao currentStep={false} viewMode={false} infos={false} />}
