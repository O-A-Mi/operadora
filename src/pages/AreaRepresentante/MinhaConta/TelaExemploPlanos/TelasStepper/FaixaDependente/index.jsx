...
const FaixaDependente = ({ isMobile = false, currentStep }) => {
  ...
  const handleAdicionar = useCallback(() => {
    if (!parentesco || !faixaInicial || !faixaFinal || !valorCusto || !valorVenda || !modoAdesao || !valorAdesao || !tipoReajuste || !valorANS || !valorIGPDI || !valorIGPM) {
      dialogMessage(
    ...
    setValorIGPDI('');
    setValorIGPM('');
  }, [parentesco, faixaInicial, faixaFinal, valorCusto, valorVenda, modoAdesao, valorAdesao, tipoReajuste, valorANS, valorIGPDI, valorIGPM]);
  ...
  const tabelaColumns = useMemo(() => [
    { value: 'parentesco', name: 'Parentesco' },
    ...
    { value: 'parentescoVinculado', name: 'Parentesco Vinculado' }
  ], []);
    ...
    <div className={styles.container}>
      <div className={styles.formSection}>
        <h3 className={styles.sectionTitle}>
          ...
          Faixa do Dependente por Idade
        </h3>

        <div className={styles.formRow}>
          <UseInputPadrao 
            label="Parentesco a ser incluídos"
            identifier="parentesco" 
            value={parentesco}
...
export default FaixaDependente;