 ...
 import HomeCliente from "../HomeBeneficiario/index";
 import ModuleMap from "./ModuleMap";
 import { useModuleMap } from '../../../context/ModuleMapContext';
 import { useArea } from '../../../context/AreaContext';
 
 const Beneficiario_MinhaConta = () => {
   ...
   useEffect(() => {
    ...
    useEffect(() => {
      const isHomePage = currentPath === `/${jsonRoute.Beneficiario_MinhaConta}`;
   ...
   const renderRotaTelas = useMemo(() => {
     ...
     return rotaTelas
       ...
       .map((item, index, array) => {
         ...
         let path = `/${jsonRoute.Beneficiario_MinhaConta}`;
         ...
         const homePath = `/${jsonRoute.Beneficiario_MinhaConta}`;
 ...
 export default Beneficiario_MinhaConta;