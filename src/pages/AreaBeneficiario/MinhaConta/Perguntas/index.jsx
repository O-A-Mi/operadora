...
const Perguntas_Declaracao = () => {
    ...
    const basePath = `/${jsonRoute.Beneficiario_MinhaConta}/${jsonRoute.Perguntas_Declaracao}`;
        ...
        <>
            <div className={styles.contratoContainer}>
                <h2 className={styles.titleTela}>
                  <i className="fa-solid fa-message-question" />
                  <span>Perguntas da Declaração</span>
                </h2>
...
export default Perguntas_Declaracao;